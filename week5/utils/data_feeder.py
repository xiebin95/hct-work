...
from week6.utils.process_labels import encode_labels, verify_labels
from week6.utils.image_process import crop_resize_data, crop_val_resize_data
...
def train_image_gen(train_list, batch_size=4, image_size=[384, 128], crop_offset=690):
    # Arrange all indexes
        ...
        for index in all_batches_index:
            if os.path.exists(image_dir[index]):
                ...
                if len(out_images) >= batch_size:
                    ...
                    out_images = out_images[:, :, :, ::-1] / (255.0 / 2) - 1
